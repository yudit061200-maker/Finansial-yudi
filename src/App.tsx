...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans antialiased selection:bg-indigo-500 selection:text-white flex flex-col justify-between pb-20 md:pb-0">
      {/* Top Bar Header */}
      <Header
        activeTab={activeTab}
      ...
      <footer className="hidden md:block border-t border-slate-200 bg-white py-3.5 text-xs text-slate-500 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
            <span className="font-bold text-slate-800">ArthaSmart AI</span>
            <span className="text-slate-300">•</span>
            <div className="flex items-center gap-1.5 text-emerald-700 bg-emerald-50 border border-emerald-200/60 px-2 py-0.5 rounded-md font-medium text-[11px]">
              {isDbLoaded ? (
                <>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="text-slate-500 hover:text-indigo-600 transition-colors flex items-center gap-1.5 text-[11px] font-medium cursor-pointer"
            ...
            <span className="text-slate-300">|</span>
            <span className="text-[11px] text-slate-400 font-medium">Cloud Database Storage</span>
          </div>
        </div>
      </footer>
